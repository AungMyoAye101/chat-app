...
const DefaultChat = () => {
    return (
        <section className=' h-full relative border-3a border-neutral-200 shadow-lg  flex flex-col items-center justify-center rounded-lg overflow-hidden bg-white'>
